/*
  ...
  Lexicon, Write, Progress, Profile). The Write (Handwriting, beta) tab follows
  settings.handwriting; the Progress tab is opt-in via settings.showProgress.
*/
...
const ICONS = {
  ...
  write: '<svg viewBox="0 0 24 24"><path d="M4 20l1-4 10.5-10.5a2.1 2.1 0 0 1 3 3L8 19l-4 1z" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linejoin="round"/><path d="M13.5 7.5l3 3" stroke="currentColor" stroke-width="2.2"/></svg>',
...
const TABS = [
  ...
  { id: 'write', label: 'Write', href: 'write.html', optional: 'handwriting' },
