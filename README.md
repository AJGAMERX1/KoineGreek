...
9. [x] **Handwriting tracing.** A canvas in the alphabet lessons: trace each letter over a faint guide with finger, pencil or mouse; stroke coverage check; re-usable by the writing assignments.
